...
public class InterfaceInfoController {
    ...
    @Resource
    private TinapiClient tinapiClient;
  ...
  /*  @PostMapping("/search/page/vo")
    ...
    public BaseResponse<Boolean> onlineInterfaceInfo(@RequestBody IdRequest idRequest, HttpServletRequest request) {
        ...
        // 测试接口是否可以调用
        com.tintin.tinapiclientsdk.model.User user = new com.tintin.tinapiclientsdk.model.User();
        user.setName("testInterface");
        String username = tinapiClient.postUsername(user);
    ...
    public BaseResponse<Object> invokeInterfaceInfo(@RequestBody InterfaceInfoInvokeRequest interfaceInfoInvokeRequest, HttpServletRequest request) {
        ...
        TinapiClient tinapiClient = new TinapiClient(accessKey, secretKey);

        // 发送请求
        Gson gson = new Gson();
        com.tintin.tinapiclientsdk.model.User user = gson.fromJson(userRequestParams, com.tintin.tinapiclientsdk.model.User.class);
        String postUsername = tinapiClient.postUsername(user);
